import newProjectData from "../../../../playwright_academy/src/pages/assets/ddt/new_project_data.json";
...
/*
 * TODO list přípravy DDT
 1. Vytvoření JSON
 2. Příprava Page Objectů
 3. V testu získáme JSON soubor (importujeme)
 4. Vytvoříme cyklus, který nám procyklí data
 5. V cyklu vytvoříme test s dynamickým názvem (název vezmeme z JSON)
 6. Připravíme project name pomocí fakeru a dat z JSON
 7. Připravíme start_date v požadovaném formátu
 8. Vytvoříme kroky, které vytvoří projekt a zkontrolují jeho založení
 9. Naplníme kroky připravenými daty (JSON + vygenerovaná data)
 10. Spustíme testy a případně opravíme chyby
*/
